...
SECTIONS: tuple[Section, ...] = (
    ...
    Section("6", "Equities, Sectors & Sentiment", (
        ...
        Field("SPY 200d SMA", "technicals_SPY", "sma.sma_200"),
