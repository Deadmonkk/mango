...
TOOL_MAP_FR: dict = {
    ...
    "cpi_components": (a(fred.get_cpi_components_dashboard), (), {}),
    "jolts": (a(fred.get_jolts_dashboard), (), {}),
    "credit_spreads": (a(fred.get_credit_spreads_dashboard), (), {}),
    "consumer_health": (a(fred.get_consumer_health_dashboard), (), {}),
    "fiscal_health": (a(fred.get_fiscal_dashboard), (), {}),
    "commodities": (a(fred.get_commodities_dashboard), (), {}),
    "liquidity": (a(fred.get_liquidity_dashboard), (), {}),
    "rates_dashboard": (a(fred.get_rates_dashboard), (), {}),
    "fed_path": (a(market_data.get_fed_path), (), {}),
    "cycle_position": (a(cycle.get_cycle_position), (), {}),
    "mc_hy_spread": (a(fred.get_metric_context), ("hy_spread",), {}),
    # --- EY-gap panel (11): 10 metric_context series + GSCPI web_search ---
    **{f"mc_{sid}": (a(fred.get_metric_context), (sid,), {}) for sid in _EY_GAP_SERIES},
