...
@tool
async def terminalq_get_crypto_derivatives() -> dict:
...
@tool
async def terminalq_get_crypto_technicals(symbol: str) -> dict:
...
@tool
async def terminalq_get_crypto_correlations(symbol: str = "BTC") -> dict:
