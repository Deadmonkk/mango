...
@tool
async def terminalq_get_economic_indicator(indicator: str, limit: int = 12) -> dict:
...
@tool
async def terminalq_get_consumer_health() -> dict:
...
@tool
async def terminalq_get_metric_context(indicator: str) -> dict:
...
@tool
async def terminalq_get_correlation_regime(symbols: str = "") -> dict:
...
@tool
async def terminalq_get_dealer_gamma(symbol: str = "SPY") -> dict:
...
@tool
async def terminalq_get_climate_risk_watch() -> dict:
...
@tool
async def terminalq_get_climate_stress_backtest(period: str = "el_nino_2015_16") -> dict:
...
@tool
async def terminalq_get_metric_stress_backtest(event: str) -> dict:
...
@tool
async def terminalq_get_percentile_context(indicator: str, value: float) -> dict:
